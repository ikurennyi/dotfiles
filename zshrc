...
plugins=(git brew brew-cask osx rails bundler sublime colored-man colorize zsh-syntax-highlighting) 

LANG=ru_RU.UTF-8

# User configuration

export PATH="$HOME/.rbenv/bin:/Applications/Postgres.app/Contents/Versions/9.4/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"
